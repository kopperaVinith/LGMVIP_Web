...
function result() {
  ...
  newPara5.innerHTML = image.value;
  newPara6.innerHTML = contact.value;
  newPara7.innerHTML = address.value;
  newPara8.innerHTML = college.value;
  newPara9.innerHTML = "----------------------------------------------";
}
...
function check() {
  ...
  if (image.value == 0) {
    window.alert("Select Your Image");
    image.focus();
